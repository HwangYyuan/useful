<template>
	<span :class="classObj.wrapper" @click.stop="handleClick">
		<span :class="[classObj.input, {'is-indeterminate': indeterminate, 'is-checked': checked, 'is-disabled': disabled}]">
			<span :class="classObj.inner"></span>
		</span>
	</span>
</template>
...
<style>
	...
	.ly-radio__inner {
		border-radius: 50%;
		width: .453333rem !important;
		height: .453333rem !important;
	}
